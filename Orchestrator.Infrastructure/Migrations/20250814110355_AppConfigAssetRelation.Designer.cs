...
namespace Orchestrator.Infrastructure.Migrations
{
    ...
    [Migration("20250814110355_AppConfigAssetRelation")]
    partial class AppConfigAssetRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orchestrator.Domain.Entities.Config", b =>
                {
                    b.HasOne("Orchestrator.Domain.Entities.App", null)
                        .WithMany()
                        .HasForeignKey("AppId")
            ...
            modelBuilder.Entity("Orchestrator.Domain.Entities.ConfigAsset", b =>
                {
                    b.HasOne("Orchestrator.Domain.Entities.Config", null)
                        .WithMany()
